...
PL_METER_OTA_SEND_UPDATE_BUF,
PL_METER_OTA_SEND_UPDATE_BUF_RSP,
PL_METER_OTA_GET_PACKNO,
PL_METER_OTA_GET_PACKNO_RSP,
PL_METER_OTA_RESEND_UPDATE_BUF,
OTA_GET_MTR_UPDATE_PWD,
};
